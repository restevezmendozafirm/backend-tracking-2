                        ...
                        <form method="POST" action="{{ route('password.confirm') }}">
                            ...
                            <div class="flex flex-wrap  mb-0">
                                <div class="md:w-2/3 pr-4 pl-4 md:mx-1/3">
                                    <button type="submit"
                                        class="btn-blue inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600 bg-blue-500">
                                        {{ __('Confirm Password') }}
                                    </button>
