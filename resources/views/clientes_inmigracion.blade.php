    ...
    <div class="bg-light-texture grid lg:grid-cols-1 md:grid-cols-1 xs:grid-flow-row sm:grid-flow-row">
        <div
            ...
            <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900">
                    <h1 class="text-6xl text-green-700 transition-all hover:text-green-900">
                        {{ __('Clientes Potenciales Landing Inmigración') }}</h1>
                </div>
            ...
            <div class="container mx-auto">
                ...
                <label for="filtroEnviadoDatos" class="ml-8">Filtrar por Estado:</label>
                <select id="filtroEnviadoDatos">
                    <option value="todos">Todos</option>
                    <option value="solo_enviado">Enviados</option>
                ...
                <a href="https://mendozafirm.com/wp-content/plugins/descargar/descargar_clientes_potenciales_inmigracion.php" class="mr-8 btn-green inline-block align-middle text-center select-none border mt-2.5 float-right whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline text-white hover:bg-blue-600 bg-blue-500 font-bold">Descargar Registros</a><br>
                <br>
                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr>
                                ...
                                <th data-sort="pid" class="border px-4 py-2">Mensaje</th>
                        ...
                        <tbody>
                            ...
                            @endphp
                                <tr data-envio="{{ $cliente->enviado_cli ? 'No Enviado' : 'Enviado' }}">
                                    ...
                                    <td class="border px-4 py-2" data-type="tel">{{ $data_decode['mensaje'] }}</td>
