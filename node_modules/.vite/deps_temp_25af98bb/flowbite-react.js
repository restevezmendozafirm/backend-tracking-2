...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react9.forwardRef)(({ children, className, color = "info", disabled = false, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner: SpinnerComponent = (0, import_jsx_runtime13.jsx)(Spinner, {}), gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size: size2 = "md", theme: customTheme = {}, ...props }, ref) => {
...
function FloatingFocusManager(props) {
  ...
  function renderDismissButton(location) {
    return visuallyHiddenDismiss && modal ? React4.createElement(VisuallyHiddenDismiss, {
...
function findNonDisabledIndex(listRef, _temp) {
  ...
  } while (index3 >= 0 && index3 <= list.length - 1 && (disabledIndices ? disabledIndices.includes(index3) : list[index3] == null || ((_list$index = list[index3]) == null ? void 0 : _list$index.hasAttribute("disabled")) || ((_list$index2 = list[index3]) == null ? void 0 : _list$index2.getAttribute("aria-disabled")) === "true" || isHidden3(list[index3])));
  return index3;
}
