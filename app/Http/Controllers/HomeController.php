...
use App\Models\ClientePotencialInmigracion;
...
class HomeController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        if ($perPage == 'all') {
            ...
            $clientesPotenciales = ClientePotencial::select('correo_cli', 'campos_cli', 'enviado_cli', 'pid_cli', 'update_cli', 'create_cli')
    ...
    public function inicio(Request $request) 
    {
        ...
        if ($perPage == 'all') {
            // Si se selecciona "Todos", se obtienen todos los registros
            $clientesPotenciales = ClientePotencialInmigracion::select('correo_cli', 'campos_cli', 'enviado_cli', 'pid_cli', 'update_cli', 'create_cli')
            ->orderBy('update_cli', 'desc')
            ->paginate(PHP_INT_MAX);
